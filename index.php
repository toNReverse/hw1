      ...
      <footer>
        <div class="footer-container">
          <div class="footer-column">
            ...
            <p><img class="wa-icon" src="../mhw1/img/whatsapp.png"><strong id = "traslate">WhatsApp</strong></p>
  ...
  <div id="login-modal" class="modal hidden">
    <div class="modal-content">
      ...
      <p class="privacy-text">
        Effettuando il login con il mio account social, accetto di collegare l’account ai sensi della <strong>Politica sulla privacy</strong>
      </p>
  ...
  <div id="cart-modal" class="modal hidden">
    <div class="model cart-empty">
      ...
      <div class="cart-empty-content">
        ...
        <button class="discover-btn">SCOPRI</button>
      </div>
    </div>
  </div>
